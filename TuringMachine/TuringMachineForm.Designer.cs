...
namespace DusanRodina.TuringMachineSimulator {
	partial class TuringMachineForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.miCompressTape = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.miAllowNondeterminism = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.infiniteTapeControl.IsInfinite = true;
			...
			// miCompressTape
			// 
			this.miCompressTape.Name = "miCompressTape";
			resources.ApplyResources(this.miCompressTape, "miCompressTape");
			this.miCompressTape.Click += new System.EventHandler(this.miCompressTape_Click);
			// 
			// miClearTape
			// 
			...
			// 
			// miAllowNondeterminism
			// 
			this.miAllowNondeterminism.Checked = true;
			this.miAllowNondeterminism.CheckOnClick = true;
			this.miAllowNondeterminism.CheckState = System.Windows.Forms.CheckState.Checked;
			this.miAllowNondeterminism.Name = "miAllowNondeterminism";
			resources.ApplyResources(this.miAllowNondeterminism, "miAllowNondeterminism");
			this.miAllowNondeterminism.Click += new System.EventHandler(this.miAllowNondeterminism_Click);
			// 
			// miWriteLog
			// 
		...
		private System.Windows.Forms.ToolStripMenuItem miCompressTape;
		...
		private System.Windows.Forms.ToolStripMenuItem miAllowNondeterminism;
